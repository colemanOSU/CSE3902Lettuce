...
{
    internal class WolfFaceRightSprite : ILinkSpriteTemp
    {
        private Texture2D _texture;
        private Game1 myGame;

        private Rectangle sourceRectangle = new(0, 26, 17, 20);
        private Rectangle destinationRectangle;
        public WolfFaceRightSprite(Texture2D texture, Game1 game)
        {
            _texture = texture;
            myGame = game;
        }
