...
{
    internal class WolfFaceLeftSprite : ILinkSpriteTemp
    {
        private Texture2D _texture;
        private Game1 myGame;

        private Rectangle sourceRectangle = new(1, 3, 17, 20);
        private Rectangle destinationRectangle;
        public WolfFaceLeftSprite(Texture2D texture, Game1 game)
        {
            _texture = texture;
            myGame = game;
        }
